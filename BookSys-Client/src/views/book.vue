...
<script type="es6">
  export default {
    ...
    methods: {
      ...
      request (currentPage){
        var that=this
        this.$http.post('http://localhost:8001' + '/book/getAllAlbums',
          {
      ...
      ok (name) {
        ...
        this.$refs[name].validate((valid) => {
          if (valid) {
            that.$http.post('http://localhost:8001' + '/book/addAlbum',
              {
      ...
      ok2 (name) {
        ...
        this.$refs[name].validate((valid) => {
          if (valid) {
            that.$http.post('http://localhost:8001' + '/book/addSubAlbum',
              {
                aid: that.currIndex,
